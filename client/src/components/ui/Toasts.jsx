...
export const ColorToast = ({ children }) => {
    ...
    return (
        ...
        <div className={`${color}font-orbitron ring-2 flex justify-center items-center  border border-cyan-400 rounded-lg m-6 mt-15 h-10 w-30 text-2xl  p-8 text-center`}>{children}</div>)
