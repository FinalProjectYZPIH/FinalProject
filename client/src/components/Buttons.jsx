...
export const MediaButtons = ({ children }) => {
  return (
    <div className="flex items-center justify-center">
      <button className="m-2 p-2 flex items-center bg-transparent  bg-opacity-60 border border-cyan-400 rounded-lg shadow-md text-sm font-medium text-gray-800 hover:bg-cyan-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-300">
        {children}
      </button>
    </div>
  );
